...
## Data Preprocessing
1. Get a short clip of video 
2. Convert to frame by frame images: ffmpeg -i gt_rgb.mp4 -qscale:v 2 ./image/%05d.jpg
3. Run mega-sam pipeline. 
4. convert outputs with the script in toolbox!

Then run data generator
Then run finetune 
Then run demo